...
from swarm.bas.wrappers.action.angular import AngularActionWrapper
...
def create_env(
    ...
    env = wrappers.ObservationContainerWrapper(
        env,
        [
            components.TargetDirectionDistanceObservationComponent(target, 180, 0.1),
        ],
    )
...
if __name__ == "__main__":
    ...
    train(curriculum, experiment_path, num_processes=6, video_every_n_steps=250000)
