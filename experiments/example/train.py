...
# curriculum is a list of chapters where each chapter defined a number of steps and to train the model using the environment as given by the create_env function. The model is saved after each chapter.
curriculum = [
    (
        1000000,
        lambda: create_env(
...
if __name__ == "__main__":
    ...
    train(curriculum, experiment_path, num_processes=16, video_every_n_steps=None)
